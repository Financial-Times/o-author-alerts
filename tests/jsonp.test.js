...
describe('jsonp.get()', function() {
	...
	it('writes a script to the head of the page', function() {
		...
		const script = document.getElementsByTagName('head')[0].querySelector('script');
	...
	it('appends a callback name to the end of the url', function() {
		...
		const script1 = document.getElementsByTagName('head')[0].querySelectorAll('script')[0];
	...
	it('queues up requests', function() {
		...
		let scripts = document.getElementsByTagName('head')[0].querySelectorAll('script');
